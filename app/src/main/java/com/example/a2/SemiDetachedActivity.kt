...
class SemiDetachedActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listings = listOf<Listing>(
            Listing("444 Cedar St", "$350,000", R.drawable.semi_detached_1),
            Listing("555 Spruce St", "$330,000", R.drawable.semi_detached_2),
            Listing("666 Walnut St", "$370,000", R.drawable.semi_detached_3)
        )

        val linearLayoutHomes = findViewById<LinearLayout>(R.id.llSemi)
